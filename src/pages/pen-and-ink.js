 ...
 <div className="sm:w-1/1 md:w-1/2">
  <img src={pen} className="top"/>
   ...
   <section className="md:w-2/3 px-1 pt-5 font-light">
        ...
        <h3>Description</h3>
        <p>Pen and Ink is a writing workship for individuals who have special needs. I've run this once so far and hope to do hold more workshops in the future.</p>
