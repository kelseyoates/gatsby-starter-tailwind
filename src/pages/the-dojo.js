    ...
    Read online for free or purchase to download.
      ...
      Description</h3>
        ...
        <p>Buy the book and you'll receive a PDF of the script.</p>
           ...
           <a href="https://gum.co/EgnY" target="blank" className="no-underline "><button className="border-grey-darker hover:border-grey-dark bg-dark-purple hover:bg-pink font-bold px-6 py-3 rounded text-sm text-white">Buy Play</button></a>
...
<p> Danny said he had something big to do.</p>
<p className="character">Hooligan 3 </p>

<p> What is it? How come he didn’t come early?</p>
<p className="character">Hooligan 2 </p>

<p> I dunno, maybe he’s getting something ready.</p>
<p className="character">Hooligan 1 </p>

<p> Well he’s better get here soon. It’s Thursday afternoon and I got things to do. I’m wasting my time here when I could be watching perfectly good Reba reruns.</p>
<p className="character">Hooligan 2 </p>

<p> Aww, can it, Kirby. If Danny says we should be here, then we should be here.</p>
<p className="character">Hooligan 3 </p>
...
<p> Well well well if it isn’t his majesty.</p>
<p className="character">Danny</p>
...
<p> Hey, Faye. I’m loving this party. I’m learning so many awesome self-defense moves.</p>
<p className="character">Taylor Swift</p>

<p> Yeah, Faye, this has been amazing. And your cake was fabu-fan-tabulous. And you know how rarely I combine words.</p>
<p className="character">Faye</p>

<p> Thanks, guys, and thanks to everyone who came out to my party. It’s been a real blast having everyone together. I know it’s my birthday, but it’s really just a chance for all of us to get together and have fun. That and getting loads of presents.</p>
...
<p> I can do anything I want! I’m Danny, of the Jackson 4! I am here to Take. You. Out.</p>
<p className="character">Faye</p>
...
<p> <span class="parenthetical">(whimpering)</span> You may have won this one, Faye, but I am still very victorious. For it is I, Danny McDanny, who has just killed your mother!</p>
...
<p>I’m sorry you had to think that I was dead, Faye, but it was the only thing I could do to protect you.</p>
<p className="character">Faye</p>

<p> It’s cool.</p>
<p className="character">Danny</p>

<p> Fine, I’m outta here. I’ll go terrorize another town. Maybe Walpole, maybe Dedham. But this ain’t the last you’ll see of me. I promise.</p>
<p className="character">Faye</p>
