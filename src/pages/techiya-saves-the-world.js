    ...
    Read online for free or purchase to download.
      ...
      Description</h3>
        ...
        <p>Buy the book and you'll receive a PDF of the script.</p>
           ...
           <a href="https://gum.co/gpazv" target="blank" className="no-underline "><button className="border-grey-darker hover:border-grey-dark bg-dark-purple hover:bg-pink font-bold px-6 py-3 rounded text-sm text-white">Buy Play</button></a>
